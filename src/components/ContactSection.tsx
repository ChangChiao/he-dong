    ...
    <section id="contact" className="scroll-mt-16 bg-cream px-6 py-20 lg:px-[120px] lg:py-[100px]">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-20">
          {/* Form */}
          <form className="flex flex-1 flex-col gap-6 border border-border bg-white p-8 lg:p-12">
          ...
          <div className="flex w-full flex-col gap-8 lg:w-[400px]">
            <div className="flex flex-col gap-5">
              <h3 className="font-[family-name:var(--font-noto-serif-tc)] text-2xl font-bold text-brown">
                快速聯繫
              </h3>
